...
object.polygons[2].vertexIndices = [4, 6, 5];
object.polygons[3].vertexIndices = [4, 7, 6];
object.polygons[4].vertexIndices = [0, 3, 7];
object.polygons[5].vertexIndices = [0, 7, 4];
object.polygons[6].vertexIndices = [0, 5, 1];
object.polygons[7].vertexIndices = [0, 4, 5];
object.polygons[8].vertexIndices = [1, 6, 2];
object.polygons[9].vertexIndices = [1, 5, 6];
